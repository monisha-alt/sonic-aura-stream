...
import { List, Disc, User, Music, MapPin, Headphones } from "lucide-react";
  ...
  return (
    <div className="w-full md:w-64 p-4 border-r border-gray-700 space-y-6">
      <div className="space-y-2">
        ...
        <Link to="/live" className="flex items-center space-x-2 text-gray-300 hover:text-white p-2 rounded hover:bg-gray-800">
