...
const SpotifyConnect: React.FC<SpotifyConnectProps> = ({ onConnectionChange }) => {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Connect your Spotify account to stream real songs and create personalized playlists
        </CardDescription>
      </CardHeader>
        ...
        {!isConnected ? (
          <>
            <div className="text-sm text-muted-foreground">
              <p className="mb-2">Benefits of connecting Spotify:</p>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Stream real songs instead of placeholder tracks</li>
                <li>Create and save custom playlists</li>
                <li>Access your existing Spotify playlists</li>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    You can now stream real songs and create playlists
                  </p>
                </div>
              </div>
            </div>
