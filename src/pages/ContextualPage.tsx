...
import ContextualPlayer from "@/components/ContextualPlayer";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-4 pb-24">
          <h2 className="text-2xl font-bold mb-6">Contextual Music Recommendations</h2>
          <p className="text-gray-300 mb-6">
            Get personalized song recommendations based on your location, the weather, and time of day
          </p>
